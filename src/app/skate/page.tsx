    ...
    <div className="min-h-screen">
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            <h2 className="text-5xl md:text-6xl font-bold text-black mb-4">Skate</h2>
            <p className="text-lg text-gray-600">{skateImages.length} photos</p>
          </div>

          {/* Photo Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skateImages.map((photo) => (
              <div
                key={photo.id}
